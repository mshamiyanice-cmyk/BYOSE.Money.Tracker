      ...
      <div className="bg-white rounded-[40px] shadow-2xl border border-slate-100 overflow-hidden relative">
        ...
        <div className="h-48 bg-gradient-to-br from-[#165b4c] via-slate-800 to-slate-900 relative overflow-hidden">
          ...
          <div className="absolute top-8 right-8">
             <div className={`px-5 py-2.5 rounded-2xl border-2 flex items-center gap-3 backdrop-blur-xl shadow-lg ${
               isAdmin ? 'bg-emerald-500/20 border-emerald-400/30 text-emerald-50' : 'bg-blue-500/20 border-blue-400/30 text-blue-50'
             }`}>
